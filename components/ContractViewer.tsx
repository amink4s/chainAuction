...
import { analyzeSmartContract } from '../services/auctionService';
...
export const ContractViewer: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {analysis && (
        <div className={`p-5 rounded-xl border ${analysis.riskScore > 50 ? 'bg-red-900/10 border-red-800' : 'bg-green-900/10 border-green-800'
          }`}>
